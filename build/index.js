...
var css_248z = ".pushboard {\n  display: flex;\n  flex-direction: column;\n\n  align-items: center;\n  height: 100%;\n}\n";
styleInject(css_248z);

var css_248z$1 = ".letter {\n  position: absolute;\n  font-family: \"Courier New\", Courier, monospace;\n  color: white;\n}\n\n.trashcan {\n  position: absolute;\n  font-size: 10px;\n  background-color: black;\n}\n";
styleInject(css_248z$1);

var Letter = /*#__PURE__*/function (_React$Component) {
  ...
  function Letter(props) {
    ...
    _this.letterComponent = react.createRef();

    _this.props.deleteLetter.bind(_assertThisInitialized(_this));
  ...
  _createClass(Letter, [{
    ...
    key: "stickyToTouch",
    value: function stickyToTouch(item, props) {
      var currentX = 0,
          currentY = 0,
          previousX = 0,
          previousY = 0,
          initialOffsetLeft = 0,
          initialOffsetTop = 0;
      var maxLetterOffsetLeft = props.maxLetterOffsetLeft,
      ...
      function dragMouseDown(e) {
        e = e || window.event;
        e.preventDefault();
        var touchLocation = e.targetTouches[0]; // get the mouse cursor position at startup:
      ...
      function elementDrag(e) {
        e = e || window.event;
        var touchLocation = e.targetTouches[0]; // calculate the new cursor position:
    ...
    key: "stickyToMouse",
    value: function stickyToMouse(item, props) {
      var currentX = 0,
          currentY = 0,
          previousX = 0,
          previousY = 0,
    ...
    value: function render() {
      ...
      var trashComponent = react.createElement("div", {
        className: "trashcan",
        onClick: function onClick() {
          return _this2.deleteSelf();
        }
      }, "\uD83D\uDDD1");
      return react.createElement("div", {
        ref: this.letterComponent,
        onContextMenu: function onContextMenu() {
          return _this2.onRightClick();
        },
      ...
      }, this.state.dragged ? trashComponent : null, this.props.value);
    }
  }]);
...
var BoardComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function BoardComponent(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BoardComponent).call(this, props));
  }
...
var Board = react.forwardRef(function (props, ref) {
  return react.createElement(BoardComponent, _extends({
    forwardRef: ref
  }, props));
});
...
var Factory = /*#__PURE__*/function (_React$Component) {
  ...
  function Factory(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Factory).call(this, props));

    _this.props.addLetters.bind(_assertThisInitialized(_this));

    _this.props.clearLetters.bind(_assertThisInitialized(_this));

    _this.handleAddLettersClick = _this.handleAddLettersClick.bind(_assertThisInitialized(_this));
    _this.handleLetterClear = _this.handleLetterClear.bind(_assertThisInitialized(_this));
    _this.letterInputComponent = react.createRef();
    return _this;
  }

  _createClass(Factory, [{
    key: "handleAddLettersClick",
    value: function handleAddLettersClick(e) {
      var value = this.letterInputComponent.current.value;
      this.props.addLetters(value);
    }
  }, {
    key: "handleLetterClear",
    value: function handleLetterClear(e) {
...
var Pushboard = /*#__PURE__*/function (_React$Component) {
  _inherits(Pushboard, _React$Component);

  function Pushboard(props) {
    var _this;

    _classCallCheck(this, Pushboard);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Pushboard).call(this, props));
    _this.addLetters = _this.addLetters.bind(_assertThisInitialized(_this));
    _this.clearLetters = _this.clearLetters.bind(_assertThisInitialized(_this));
    _this.deleteLetter = _this.deleteLetter.bind(_assertThisInitialized(_this));
    ...
    _this.boardRef = react.createRef();
    return _this;
  }

  _createClass(Pushboard, [{
    key: "addLetters",
    value: function addLetters(sentence) {
      var _this2 = this;

      var additionalLetters = {};
      var characters = sentence.replace(/\s/g, "").split("");
      characters.forEach(function (element, i) {
        var key = _this2.getKey();
    ...
    key: "deleteLetter",
    value: function deleteLetter(key) {
    ...
    value: function componentDidMount() {
      ...
      this.setState(function (state) {
        return {
          boardOffsetLeft: _this3.boardRef.current.offsetLeft,
          boardOffsetTop: _this3.boardRef.current.offsetTop,
          boardHeight: _this3.boardRef.current.clientHeight,
          boardWidth: _this3.boardRef.current.clientWidth
        };
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var maxCharactersHorizontal = Math.floor(this.state.boardWidth / this.props.letter_font_size) - 1;
      var maxCharactersVertical = Math.floor(this.state.boardHeight / this.props.letter_font_size) - 1;
      var minLetterOffsetLeft = this.state.boardOffsetLeft;
      var maxLetterOffsetLeft = minLetterOffsetLeft + this.state.boardWidth;
      var minLetterOffsetTop = this.state.boardOffsetTop;
      var maxLetterOffsetTop = minLetterOffsetTop + this.state.boardHeight;
      var style = {};
      ...
      return react.createElement("div", {
        ...
        ref: this.boardRef
      }), Object.keys(this.state.letters).map(function (key) {
        return react.createElement(Letter, {
          ...
          parentKey: key,
          value: _this4.state.letters[key],
          deleteLetter: _this4.deleteLetter,
          fontsize: _this4.props.letter_font_size,
          startingX: (key % maxCharactersHorizontal + 1) * _this4.props.letter_font_size + _this4.state.boardOffsetLeft,
          startingY: (Math.floor(key / maxCharactersHorizontal) % maxCharactersVertical + 1) * _this4.props.letter_font_size + _this4.state.boardOffsetTop
        });
      }));
    }
  }]);
